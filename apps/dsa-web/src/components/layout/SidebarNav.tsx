...
import { BarChart3, Bell, BriefcaseBusiness, Home, LogOut, MessageSquareQuote, Settings2, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="flex h-full flex-col">
      <div className={cn('mb-4 flex items-center gap-2 px-1', collapsed ? 'justify-center' : '')}>
        ...
        {!collapsed ? (
          <p className="min-w-0 truncate text-sm font-semibold text-foreground">STOCK</p>
        ) : null}
      </div>
